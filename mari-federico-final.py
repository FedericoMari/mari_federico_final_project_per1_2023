...
print("Place some skill you do not know well...")
unfamiliar_skill = input('>')
# will filter out/remove the input provided by the user...
print(f"Filtering out: {unfamiliar_skill}")

def find_jobs():
    # get specific info from a website, include website url as string
        ...
        if 'few' in publishing_date:
            ...
            if unfamiliar_skill not in skills:
                ...
                with open(f'posts/ {i}.txt', 'w') as f:
                    # '\n will break a line within the text file...making it more presentable'
                    ...
                    # more rugged way of organizing your lists, use prettified version^
                    # print(f'''
                    #     Company Name: {company_name}
                    #     Required Skills: {skills}
                    #     Published Date: {publishing_date}
                    #     ''')
